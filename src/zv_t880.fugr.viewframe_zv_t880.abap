*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_T880
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_T880             .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_T880'
         EXPORTING
              FCODE          = READ
...
CALL FUNCTION 'VIEWPROC_ZV_T880'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_T880-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_T880_EXTRACT
TOTAL = ZV_T880_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_T880-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_T880'
...
TOTAL = ZV_T880_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_T880-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_T880-UPD_FLAG NE SPACE.
